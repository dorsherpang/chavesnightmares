    ...
    return (
        <main className="relative bg-black text-gray-300">
            <div className="max-w-5xl mx-auto px-4 py-20 space-y-8">
                ...
                {/* ===== Download Card 1 ===== */}
                <div className="border-fear bg-black/40 hover:bg-fear-gradient transition-all duration-300">
                    <div className="p-4 flex flex-col md:flex-row md:items-center gap-4 md:gap-6 text-sm">
                        ...
                        {/* Download button */}
                        <a
                            href="https://download.gamejolt.net/5611cb277e6d03caa3f323db4b9ee0b97c787db48f1a9dbdfce932168a2f08c4,1768049944,7/data/games/16/140/1023390/files/695c3820b6c8c/chaves-nightmares-android-v1.0.4.apk"
                            target="_blank"
                ...
                <div className="border-fear bg-black/40 hover:bg-fear-gradient transition-all duration-300">
                    <div className="p-4 flex flex-col md:flex-row md:items-center gap-4 md:gap-6 text-sm">
                        ...
                        {/* Download button */}
                        <a
                            href="https://download.gamejolt.net/23a7d76b6d4842765104a8c5c4f7b53d26e12b84152c3853a2428b12b77b581f,1768050071,7/data/games/16/140/1023390/files/695c37f2448bb/chaves-nightmares-v1.0.4.zip"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center justify-center bg-red-600 text-white font-semibold uppercase tracking-widest text-xs md:text-sm px-6 md:px-8 py-3 rounded-md shadow-lg hover:bg-red-700 hover:scale-105 transition-all duration-300 whitespace-nowrap"
                        >
