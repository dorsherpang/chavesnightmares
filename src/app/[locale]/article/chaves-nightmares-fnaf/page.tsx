...
export default function ArticlePage() {
    const { t } = useI18n();
    const title = t('longtail.title11');
    const content = t('longtail.content11');
    ...
    return (
        <section className="bg-[#0f0f0f] p-6 rounded-xl border border-[#2a1a1a] shadow-[0_0_30px_rgba(139,0,0,0.15)] max-w-4xl mx-auto">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300">
                <li>{t('page5.content3-3-1')}</li>
                <li>{t('page5.content3-3-2')}</li>
                <li>{t('page5.content3-3-3')}</li>
                <li>{t('page5.content3-3-4')}</li>
            </ul><br />
            <p className="text-gray-300 mb-6 leading-relaxed">
                {t('page5.content3-2')}
            </p>
